...
{
    public partial class Ingresos : DevExpress.XtraReports.UI.XtraReport
    {
        public Ingresos()
        {
            InitializeComponent();
            ...
            xrSubreport1.ReportSource = new SubreportTotalCuenta();
        }

        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var report = ((SubreportTotalCuenta)((XRSubreport)sender).ReportSource);
            report.CargarDatos();
        }
