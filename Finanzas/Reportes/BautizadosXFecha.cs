...
{
    public partial class BautizadosXFecha : DevExpress.XtraReports.UI.XtraReport
    {
        public BautizadosXFecha()
        {
            InitializeComponent();
        ...
        public void CargarDatos()
        {
            ...
            var data = from i in db.Persona
                       where i.activo && i.fechaBautismo.HasValue && i.fechaBautismo.Value <= fechaFin && i.fechaBautismo.Value >= fechaInicio
                       orderby i.fechaBautismo.Value
                       select new
                       {
                           persona = i,
                           fecha = i.fechaBautismo.Value,
